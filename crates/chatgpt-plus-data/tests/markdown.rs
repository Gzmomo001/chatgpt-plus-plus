use chatgpt_plus_core::models::{ExportStatus, SessionRef};
use chatgpt_plus_data::MarkdownExportService;
...
fn markdown_exporter_searches_candidate_databases() {
    ...
    let result = chatgpt_plus_data::export_markdown_from_paths(
