...
const RUNTIME_COMPAT_SCRIPT: &str = include_str!("../../../assets/inject/runtime-compat.js");
...
pub fn runtime_compat_script() -> &'static str {
    RUNTIME_COMPAT_SCRIPT
}
...
pub fn injection_script_with_settings(helper_port: u16, settings: &BackendSettings) -> String {
    ...
    format!(
        "window.__CODEX_SESSION_DELETE_HELPER__ = {};\nwindow.__CHATGPT_PLUS_VERSION__ = {};\nwindow.__CHATGPT_PLUS_BUILD__ = {};\nwindow.__CHATGPT_PLUS_IMAGE_OVERLAY__ = {};\nwindow.__CHATGPT_PLUS_PLUGIN_MARKETPLACES__ = {};\nwindow.__CHATGPT_PLUS_PASTE_FIX__ = {};\nwindow.__CHATGPT_PLUS_FORCE_CHINESE_LOCALE__ = {};\nwindow.__CHATGPT_PLUS_FAST_STARTUP__ = {};\n{}\n{}\n{}",
