...
pub const WATCHER_RUN_NAME: &str = "ChatGPTPlusPlusWatcher";
pub const WATCHER_RUN_KEY: &str = r"Software\Microsoft\Windows\CurrentVersion\Run";
pub const WATCHER_STARTUP_SHORTCUT_NAME: &str = "ChatGPTPlusPlusWatcher.lnk";
    ...
    processes
        ...
        .filter(|(process_id, _, exe_file)| {
            !protected.contains(process_id)
                && (exe_file.eq_ignore_ascii_case("chatgpt-plus-plus.exe")
