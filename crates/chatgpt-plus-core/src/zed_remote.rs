...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read ChatGPT++ Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse ChatGPT++ Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write ChatGPT++ Zed remote project registry")]
