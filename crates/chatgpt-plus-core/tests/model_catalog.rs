...
async fn model_catalog_uses_manual_profile_models_without_upstream_fetch() {
    ...
    let previous_settings_path =
        chatgpt_plus_core::paths::set_settings_path_for_tests(Some(settings_path.clone()));
    unsafe {
    ...
    chatgpt_plus_core::paths::set_settings_path_for_tests(previous_settings_path);
