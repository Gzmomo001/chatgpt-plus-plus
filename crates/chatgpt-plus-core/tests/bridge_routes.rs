...
async fn user_script_manager_deletes_market_script_metadata_and_rejects_builtin_delete() {
    ...
    let script = chatgpt_plus_core::script_market::MarketScript {
        id: "demo".to_string(),
        name: "Demo".to_string(),
    ...
    chatgpt_plus_core::script_market::install_market_script_content(
        &manager,
        &script,
        b"window.demo = true;",
    )
...
fn script_market_manifest_filters_invalid_entries() {
    ...
    let manifest = chatgpt_plus_core::script_market::parse_market_manifest(raw).unwrap();
...
fn user_script_inventory_includes_market_metadata() {
    ...
    manager
        .record_market_install(&chatgpt_plus_core::script_market::MarketScript {
            id: "demo".to_string(),
            name: "Demo".to_string(),
...
fn install_market_script_ignores_checksum_mismatch_and_replaces_existing_file() {
    ...
    chatgpt_plus_core::script_market::install_market_script_content(&manager, &script, b"new")
        .unwrap();
