...
export const EN_PLAIN: Record<string, string> = {
  ...
  "保存到 ChatGPT++ state，不改写 Zed settings。": "Saved to ChatGPT++ state, does not modify Zed settings.",
  ...
  "检测到来自网页的供应商配置导入请求，确认后会写入本机 ChatGPT++ 管理工具。":
    "A provider config import request from the web was detected; confirming writes it to this machine's ChatGPT++ manager.",
  "概览": "Overview",
  ...
  "维护 ChatGPT++ 自己的远程项目最近列表。": "Maintain ChatGPT++'s own recent list of remote projects.",
  "编辑": "Edit",
  "编辑后保存列表，再切换模式时会使用新配置": "After editing, save the list; the new config is used the next time you switch modes",
  "编辑扩展项": "Edit entry",
  "缺失": "Missing",
  "缺少 ChatGPT++ 静默启动快捷方式时可在安装维护页修复。": "When the ChatGPT++ silent launch shortcut is missing, repair it on the Install & Maintenance page.",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} 个": "{0}",
  "{0} 个 ChatGPT++ 可识别项目，默认策略：{1}": "{0} project(s) recognized by ChatGPT++, default strategy: {1}",
  "{0} 个供应商": "{0} provider(s)",
