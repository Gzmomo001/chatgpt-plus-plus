...
export const EN_PLAIN: Record<string, string> = {
  ...
  "偏好、安装维护、更新与诊断": "Preferences, maintenance, updates and diagnostics",
  ...
  "遇到问题时，请先复制诊断报告，再前往 GitHub 反馈，并将报告粘贴到 Issue 中。":
    "If you run into a problem, copy the diagnostic report first, then report it on GitHub and paste the report into the Issue.",
  "项目地址": "Project URL",
