...
export const EN_PLAIN: Record<string, string> = {
  ...
  "管理 upstream worktree 辅助能力。": "Manage upstream worktree helper capabilities.",
  ...
  "把 ChatGPT++ 菜单插入 Codex 顶部原生菜单栏。": "Insert the ChatGPT++ menu into Codex's top native menu bar.",
