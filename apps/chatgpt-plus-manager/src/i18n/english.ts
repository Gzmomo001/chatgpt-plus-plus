...
export const EN_PLAIN: Record<string, string> = {
  ...
  "插件市场 URL": "Plugin marketplace URL",
  "插件市场 URL，例如 https://github.com/owner/repo": "Plugin marketplace URL, for example https://github.com/owner/repo",
  "注册远程市场": "Register remote marketplace",
  "正在注册…": "Registering…",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "ChatGPT 已启动。": "ChatGPT is already running.",
  ...
  "供应商已切换；model_provider 未变化，无需同步历史会话。若 ChatGPT 正在运行，请手动重启后生效。":
    "Provider switched; model_provider did not change, so history sync was not needed. If ChatGPT is running, restart it manually for the change to take effect.",
  ...
  "供应商配置已应用。若 ChatGPT 正在运行，请手动重启后生效。":
    "Provider configuration applied. If ChatGPT is running, restart it manually for the change to take effect.",
  "纯 API 供应商配置已应用。若 ChatGPT 正在运行，请手动重启后生效。":
    "Pure API provider configuration applied. If ChatGPT is running, restart it manually for the change to take effect.",
  "已清除 custom 中转 API 模式，并切换到官方 ChatGPT 登录模式。若 ChatGPT 正在运行，请手动重启后生效。":
    "Custom relay API mode cleared and official ChatGPT login mode selected. If ChatGPT is running, restart it manually for the change to take effect.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^供应商已切换，历史会话已自动同步到 (.+)。若 ChatGPT 正在运行，请手动重启后生效。$/, "Provider switched and historical sessions were automatically synced to $1. If ChatGPT is running, restart it manually for the change to take effect."],
  [/^供应商已切换，但历史会话自动同步未完成：(.+)。若 ChatGPT 正在运行，请手动重启后生效。$/, "Provider switched, but automatic history sync did not complete: $1. If ChatGPT is running, restart it manually for the change to take effect."],
