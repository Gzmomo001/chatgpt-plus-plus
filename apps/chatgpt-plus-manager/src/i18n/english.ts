...
export const EN_PLAIN: Record<string, string> = {
  ...
  "设置一次默认路径，也可以临时覆盖后启动": "Set a default path once, or temporarily override it before launch",
  ...
  "安装、卸载或修复 ChatGPT++ 系统入口": "Install, remove or repair ChatGPT++ system entrypoints",
  ...
  "日志文件夹": "Log folder",
  "日志记录": "Logging",
  "日志记录已关闭": "Logging is off",
  "日志路径将在加载后显示": "The log path will appear after loading",
  "释放并注册内置缓存": "Extract and register embedded cache",
  "更多选项": "More options",
  "更新安装": "Update install",
  "最新版本": "Latest version",
  "启用日志记录": "Enable logging",
  "正在记录运行诊断信息": "Runtime diagnostics are being recorded",
  "打开日志文件夹": "Open log folder",
  "控制 ChatGPT++ 的运行诊断日志；关闭后不再写入 chatgpt-plus.log。":
    "Control ChatGPT++ runtime diagnostics; when off, chatgpt-plus.log is not written.",
