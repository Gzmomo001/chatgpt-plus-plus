...
Section "Install"
  ...
  CreateShortcut "$DESKTOP\ChatGPT++.lnk" "$INSTDIR\chatgpt-plus-plus.exe" "" "$INSTDIR\chatgpt-plus-plus.exe"
  CreateShortcut "$DESKTOP\ChatGPT++ 管理工具.lnk" "$INSTDIR\chatgpt-plus-plus-manager.exe" "" "$INSTDIR\chatgpt-plus-plus-manager.exe"
  CreateDirectory "$SMPROGRAMS\ChatGPT++"
  CreateShortcut "$SMPROGRAMS\ChatGPT++\ChatGPT++.lnk" "$INSTDIR\chatgpt-plus-plus.exe" "" "$INSTDIR\chatgpt-plus-plus.exe"
  CreateShortcut "$SMPROGRAMS\ChatGPT++\ChatGPT++ 管理工具.lnk" "$INSTDIR\chatgpt-plus-plus-manager.exe" "" "$INSTDIR\chatgpt-plus-plus-manager.exe"
